...
return [
    ...
    'not_authorized_to_view' => 'شما مجاز به مشاهده این سفارش نیستید',
    ...
    'shipping_address_not_authorized' => 'آدرس ارسال متعلق به شما نیست',
    ...
    'quantity_min_one' => 'تعداد باید حداقل 1 باشد',
    'quantity_max_limit' => 'تعداد نمی‌تواند بیشتر از 100000 باشد',
